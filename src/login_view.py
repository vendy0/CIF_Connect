...
async def LoginView(page: ft.Page):
    ...
    email_input = ft.TextField(label="Email", prefix_icon=ft.Icons.EMAIL, border_radius=10, multiline=False)
    password_input = ft.TextField(label="Mot de passe", prefix_icon=ft.Icons.LOCK, password=True, can_reveal_password=True, border_radius=10, multiline=False)
