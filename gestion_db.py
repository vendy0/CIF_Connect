from sqlalchemy import create_engine, Column, Integer, String, Boolean, DateTime, ForeignKey, Table, select, func, exists, event, UniqueConstraint, Index
...
print(" === Tables initialisés avec succès === ")
